...
private slots:
    ...
    bool saveNotebookAs();
    //! Сохраняет записную книжку в текстовой форме
    ...
    void deleteNotes();
    //! Позволяет редактировать созданную заметку
...
private:
    ...
    void saveNotebookToTextFile(QString fileName);
